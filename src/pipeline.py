...
def main():
    ...
    parser.add_argument('--top-k-near', type=int, default=2, help='The number of lines before and after the log anomaly to be used as a near context')
    parser.add_argument('--top-k-far', type=int, default=3, help='The number of the most similar lines to the log anomaly to be used as far context')
